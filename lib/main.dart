...
class _MyHomePageState extends State<MyHomePage> {
                        ...
                        series: <ChartSeries>[
                          LineSeries<LiveData, int>(
                            onRendererCreated:
                              ...
                              _chartSeriesController1 = seriesController;
                            },
                            dataSource: chartData,
                            color: Color.fromARGB(255, 11, 119, 191),
                            xValueMapper: (LiveData sales, _) => sales.x,
                            yValueMapper: (LiveData sales, _) => sales.y1,
                          ),
                          LineSeries<LiveData, int>(
                            onRendererCreated:
                                (ChartSeriesController sController) {
                              _chartSeriesController2 = sController;
                            },
                            dataSource: chartData,
                            color: Color.fromARGB(255, 168, 10, 26),
                            xValueMapper: (LiveData sales, _) => sales.x,
  ...
  void updateDataSource(Timer timer) {
    chartData.add(LiveData(time++, humidity, temperature));
...
class LiveData {
  LiveData(this.x, this.y1, this.y2);
  final int x;
  final double y1;
  final double y2;
}
